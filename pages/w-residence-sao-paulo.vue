      ...
      <div class="project-header">
        <div class="project-meta">
          <div class="client-info">
            <p>CLIENT: W HOTELS & RESIDENCES</p>
            <p>SERVICES: INTERIOR DESIGN / ARCHITECTURAL CONSULTING / BRANDING</p>
          </div>
        </div>
        
        <div class="project-headline">
          <h1>W THE RESIDENCE, SÃO PAULO: URBAN LUXURY LIVING IN BRAZIL'S METROPOLIS</h1>
        </div>
      ...
      <div class="project-content">
        <div class="content-section">
          ...
          <div class="content-footer">
            <a href="#" class="external-link">WRESIDENCES.COM</a>
        ...
        <div class="content-section">
          <div class="image-grid">
            <div class="grid-item">
              <img src="https://images.unsplash.com/photo-1600210492493-0946911123ea?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80" alt="Residence image 1" />
            </div>
            
            <div class="grid-item">
              <img src="https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80" alt="Residence image 2" />
            </div>
          </div>
        </div>
      </div>
