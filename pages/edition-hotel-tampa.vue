      ...
      <div class="project-header">
        <div class="project-meta">
          <div class="client-info">
            <p>CLIENT: EDITION HOTELS</p>
            <p>SERVICES: VISUAL IDENTITY / INTERIOR DESIGN / BRANDING</p>
          </div>
        </div>
        
        <div class="project-headline">
          <h1>EDITION HOTEL, TAMPA: CONTEMPORARY LUXURY ON FLORIDA'S GULF COAST</h1>
        </div>
      ...
      <div class="project-content">
        <div class="content-section">
          ...
          <div class="content-footer">
            <a href="https://www.editionhotels.com" class="external-link">EDITIONHOTELS.COM</a>
