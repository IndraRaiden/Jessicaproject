      ...
      <div class="project-header">
        <div class="project-meta">
          <div class="client-info">
            <p>CLIENT: SOUTH SEAPORT</p>
            <p>SERVICES: VISUAL IDENTITY / INTERIOR DESIGN / BRANDING / SIGNAGE</p>
          </div>
        </div>
        
        <div class="project-headline">
          <h1>THE STREET: A VIBRANT CULINARY DESTINATION IN THE HISTORIC SOUTH SEAPORT DISTRICT OF NEW YORK.</h1>
        </div>
      ...
      <div class="project-content">
        <div class="content-section">
          ...
          <div class="content-footer">
            <a href="#" class="external-link">THESTREETNY.COM</a>
